...
export type SiteData = {
  ...
  contactForm: { enabled: boolean; captchaEnabled: boolean; captchaType: "none" | "integrated" | "google_v2"; googleSiteKey: string; challengeMethod: "math" | "checkbox" | "question"; challengeQuestion: string; challengeAnswer: string; recipientLabel: string; recipientEmail: string; keepMessageCopy: boolean; timezone: string; mailTransport: "resend" | "phpmail" | "smtp_local" | "gmail" };
...
export const demoData: SiteData = {
  ...
  contactForm: { enabled: true, captchaEnabled: true, captchaType: "integrated", googleSiteKey: "", challengeMethod: "math", challengeQuestion: "¿Cuál es el color del cielo en un día despejado?", challengeAnswer: "azul", recipientLabel: "Atención comercial", recipientEmail:"", keepMessageCopy:false, timezone:"America/Asuncion", mailTransport:"resend" },
