...
$footerSocials='';if(!empty($d['footer']['showSocials']))foreach($d['socials']??[] as $network=>$url)if($url)$footerSocials.='<a href="'.Support::e($url).'" target="_blank" rel="noopener">'.Support::e($socialLabels[$network]??$network).'</a>';
?>
